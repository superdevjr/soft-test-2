import {
  populateModalWithTextBasedContent,
  populateModalWithProgressBar,
  populateModalWithReadUnreadButtons,
} from "./modal-population.js";

export function openModal(content) {
  populateModalWithTextBasedContent(content);
  populateModalWithProgressBar(content);
...
// function populateModalWithProgressBar(content) {
...
// function populateModalWithReadUnreadButtons(content) {
